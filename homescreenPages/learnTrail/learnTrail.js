    ...
    if(e.keyCode == 32){ // spacebar
        ...
        switch(pageNum){
        	...
        	case 7:
        		...
        		paragraph.innerHTML = "You may want to quit in the middle of the program.  If so, press the Escape (Esc) key twice whenever the computer is waiting for a response.";
        		break;
        	case 8:
        	...
        	default: // if something fails, or pageNum > 8...
	        	location.replace("../../proj2.html"); // ... go back to homescreen
	        	break;
...
var pageNum = 1;
var paragraph = document.getElementById('learnTrailDesc');
var paragraphHead = document.getElementById('paragraphHead');